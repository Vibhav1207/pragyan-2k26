...
export function RedesignedApp() {
  ...
  return (
    <div className="min-h-screen bg-[#F9F4EA] text-[#050C0C] relative font-sans overflow-x-hidden selection:bg-[#162E28] selection:text-[#E5BE61]">
      ...
      {/* Top Banner: Edition Switcher Indicator */}
      <div className="bg-[#162E28] text-[#F9F4EA] py-1.5 px-4 text-center border-b border-[#A77A1C]/40 text-xs font-mono flex items-center justify-center gap-2 z-50 relative">
        <Sparkles className="w-3.5 h-3.5 text-[#E5BE61] animate-pulse" />
        <span>PRAGYAN 2K26 Editorial Edition</span>
        <span className="text-[#A77A1C]">•</span>
        <Link
          to="/original"
          className="text-[#E5BE61] underline hover:text-[#F9F4EA] font-bold flex items-center gap-1 transition-colors"
        >
