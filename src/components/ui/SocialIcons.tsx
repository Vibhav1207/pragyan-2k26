...
export const SocialIcons: React.FC = () => (
  <div className="flex items-center gap-3">
    <a href="#" className="p-2.5 rounded-lg bg-white/10 hover:bg-[#FC3D21] text-white transition-colors">
      <InstagramIcon className="w-4 h-4" />
    </a>
    <a href="#" className="p-2.5 rounded-lg bg-white/10 hover:bg-[#0B3D91] text-white transition-colors">
      <LinkedinIcon className="w-4 h-4" />
    </a>
    <a href="#" className="p-2.5 rounded-lg bg-white/10 hover:bg-[#FC3D21] text-white transition-colors">
      <TwitterIcon className="w-4 h-4" />
    </a>
    <a href="#" className="p-2.5 rounded-lg bg-white/10 hover:bg-[#050505] text-white transition-colors">
