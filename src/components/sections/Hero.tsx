    ...
    <section id="home" className="w-full pt-32 pb-20 lg:pt-40 lg:pb-28 px-4 sm:px-8 lg:px-12 xl:px-16 bg-[#0B192C] text-white relative overflow-hidden text-left">
      ...
      <div className="max-w-[1500px] mx-auto w-full space-y-12 sm:space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 xl:gap-12 items-center">
          ...
          {/* Left Column: Logos, Titles, Theme, Buttons */}
          <div className="lg:col-span-6 xl:col-span-6 space-y-6 sm:space-y-8">
            <div className="space-y-4">
              ...
              <ScrollReveal delay={150} duration={600}>
                <div className="font-space font-black text-4xl sm:text-6xl xl:text-7xl tracking-tight text-white leading-none">
                  PRAGYAN <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FACC15] to-[#F59E0B]">2K26</span>
                </div>
                
                <h1 className="font-space font-black text-xl sm:text-3xl xl:text-4xl tracking-tight text-[#E6EEF8] uppercase leading-tight mt-2">
                  NATIONAL LEVEL HACKATHON
                </h1>
              </ScrollReveal>

              <ScrollReveal delay={250} duration={600}>
                <div className="p-5 sm:p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 space-y-2.5 shadow-2xl">
                  ...
                  <h2 className="font-space font-extrabold text-lg sm:text-2xl xl:text-3xl text-white uppercase leading-snug">
                    {EVENT_DATA.theme}
                  </h2>
                  <p className="font-sans font-medium text-xs sm:text-sm xl:text-base text-slate-200 leading-relaxed pt-1 border-t border-white/10">
            ...
            <ScrollReveal delay={350} duration={600}>
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                <a
                  ...
                  className="btn-secondary-gold text-sm px-7 py-3.5 sm:px-8 sm:py-4 uppercase"
                >
          ...
          {/* Right Column: Redesigned Event At A Glance Card */}
