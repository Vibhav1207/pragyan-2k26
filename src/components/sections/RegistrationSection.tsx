      ...
      <div className="max-w-[1500px] mx-auto w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <ScrollReveal delay={250} duration={600}>
            <div className="card-premium p-8 space-y-4 text-left h-full flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h4 className="font-space font-black text-2xl text-[#0B192C] uppercase flex items-center gap-1">
          ...
          <ScrollReveal delay={350} duration={600}>
            <div className="card-premium p-8 space-y-4 text-left bg-gradient-to-br from-white via-[#FACC15]/10 to-white h-full flex flex-col justify-between">
              <div className="space-y-4">
          ...
          <ScrollReveal delay={450} duration={600}>
            <div className="card-premium p-8 space-y-4 text-left border-amber-300 h-full flex flex-col justify-between">
              <div className="space-y-4">
