    ...
    <section id="about" className="w-full py-20 lg:py-28 px-4 sm:px-8 lg:px-12 xl:px-16 bg-[#F0F4FA] text-[#0B192C] text-left border-b border-slate-200">
      <div className="max-w-[1500px] mx-auto w-full space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 card-navy p-6 sm:p-8 space-y-4 text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {FOUR_CONCEPTS.map((concept, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="card-premium p-6 sm:p-8 space-y-4 bg-white text-[#0B192C] text-left group"
                >
                  <div className="flex items-center justify-between">
                    <div className="p-3.5 rounded-xl bg-[#1D4ED8]/10 text-[#1D4ED8] group-hover:bg-[#1D4ED8] group-hover:text-white transition-colors">
