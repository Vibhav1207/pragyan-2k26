  ...
  return (
    <section id="tracks" className="w-full py-20 lg:py-28 px-4 sm:px-8 lg:px-12 xl:px-16 bg-white text-[#0B192C] text-left border-b border-slate-200">
      <div className="max-w-[1500px] mx-auto w-full space-y-12">
        ...
        {/* 4 Track Cards with Staggered Scroll Reveal */}
            ...
            return (
              <ScrollReveal key={t.id} delay={150 + idx * 120} duration={650}>
                <div
                  ...
                  className="card-premium p-8 flex flex-col justify-between space-y-6 bg-gradient-to-br from-white via-[#F0F4FA]/50 to-white group border border-slate-200 hover:border-[#1D4ED8] cursor-pointer h-full transition-all duration-300 hover:-translate-y-1.5"
                >
                  <div className="space-y-4">
                    {/* Track Badge & Icon */}
                    <div className="flex items-center justify-between border-b border-slate-200 pb-4">
                      <span className="font-mono font-black text-xs px-3.5 py-1.5 rounded-lg bg-[#0B192C] text-[#FACC15] uppercase tracking-wider shadow-sm">
                        {t.number}
                      </span>
                      <div className="p-3.5 rounded-xl bg-[#1D4ED8]/10 text-[#1D4ED8] group-hover:bg-[#1D4ED8] group-hover:text-white transition-all duration-300 group-hover:scale-110">
